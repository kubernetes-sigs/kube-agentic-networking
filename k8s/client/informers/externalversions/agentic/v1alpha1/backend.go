...
type BackendInformer interface {
	...
	Lister() agenticv1alpha1.BackendLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AgenticV1alpha1().Backends(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgenticV1alpha1().Backends(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgenticV1alpha1().Backends(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AgenticV1alpha1().Backends(namespace).Watch(ctx, options)
			},
		},
		&apiagenticv1alpha1.Backend{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *backendInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiagenticv1alpha1.Backend{}, f.defaultInformer)
}

func (f *backendInformer) Lister() agenticv1alpha1.BackendLister {
	return agenticv1alpha1.NewBackendLister(f.Informer().GetIndexer())
}

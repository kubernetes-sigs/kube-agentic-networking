...
import (
	...
	agentic "sigs.k8s.io/kube-agentic-networking/k8s/client/informers/externalversions/agentic"
...
func (f *sharedInformerFactory) Agentic() agentic.Interface {
	return agentic.New(f, f.namespace, f.tweakListOptions)
}

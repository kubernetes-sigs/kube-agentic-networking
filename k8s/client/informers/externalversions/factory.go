...
import (
	...
	api "sigs.k8s.io/kube-agentic-networking/k8s/client/informers/externalversions/api"
...
type SharedInformerFactory interface {
	...
	Agentic() api.Interface
}

func (f *sharedInformerFactory) Agentic() api.Interface {
